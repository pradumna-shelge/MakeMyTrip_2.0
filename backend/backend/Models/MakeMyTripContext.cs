...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirlineId).HasName("PK__Airline__DC458213B39EEB76");
        ...
        {
            entity.HasKey(e => e.AirportId).HasName("PK__AirportD__E3DBE0EACF187888");
        ...
        {
            entity.HasKey(e => e.FlightId).HasName("PK__Flight__8A9E14EE4226F1D1");
        ...
        {
            entity.HasKey(e => e.FlightclassStructureId).HasName("PK__Flightcl__631F102C74575982");
        ...
        {
            entity.HasKey(e => e.JourneyId).HasName("PK__Journey__4159B9EFC0832AA4");
        ...
        {
            entity.HasKey(e => e.JourneyClassPriceId).HasName("PK__JourneyC__4198C048A29887E7");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__Location__E7FEA497E06935C7");
        ...
        {
            entity.HasKey(e => e.PassengerOfferId).HasName("PK__Passenge__DFBAD1A3759377C0");
        ...
        {
            entity.HasKey(e => e.PassengerTypeId).HasName("PK__Passenge__EE63A296CF7EDA7D");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A71B468DB");
        ...
        {
            entity.HasKey(e => e.SeatClassId).HasName("PK__SeatClas__41D153A84C4FCF3E");
        ...
        {
            entity.HasKey(e => e.SeatTypeId).HasName("PK__SeatLoca__7468C4FEE9211075");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C1B6D293B");
